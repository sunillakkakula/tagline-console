        ...
        <ul className="dropdown-menu">
          ...
          <li className="button-container">
            <div>
              <Button
                color="warning"
                href="https://www.novellogiks.com/product/material-dashboard-pro-react?ref=mdpr-fixed-plugin"
                target="_blank"
                fullWidth
              >
                Buy now
          ...
          <li className="button-container">
            <div>
              <Button
                color="info"
                href="https://demos.novellogiks.com/material-dashboard-pro-react/#/documentation/tutorial?ref=mdpr-fixed-plugin"
                target="_blank"
                fullWidth
              >
                Documentation
